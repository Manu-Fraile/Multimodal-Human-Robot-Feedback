...
from .modules.BaseDeepClassifier import BaseDeepClassifier
from .modules.InceptionTimeNetwork import InceptionTimeNetwork
from .utils.checks import check_and_clean_data, check_and_clean_validation_data
...
class InceptionTimeClassifier(BaseDeepClassifier, InceptionTimeNetwork):
    ...
    def build_model(self, input_shape, nb_classes, learning_rate=0.001, metrics=None, **kwargs):
        """
